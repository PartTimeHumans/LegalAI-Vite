      ...
      <footer className="py-12 text-white bg-gray-900">
        <div className="container px-4 mx-auto">
          ...
          <div className="pt-8 mt-12 text-center text-gray-400 border-t border-gray-800">
            ...
            <p>
              Follow us on 
              <a href="https://twitter.com" className="text-primary hover:underline mx-1">Twitter</a>&
              <a href="https://linkedin.com" className="text-primary hover:underline mx-1">LinkedIn</a>
            </p>
          </div>
        </div>
      </footer>
